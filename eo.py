...
def select_parents(population, fitness_scores):
    ...
    probabilities = 1 / adjusted_fitness
...
for generation in range(num_generations):
    ...
    print(f"Generation {generation+1}\t: Min Fitness = {min_fitness}, Mean Fitness = {mean_fitness}, Best Individual = {best_individual}")
